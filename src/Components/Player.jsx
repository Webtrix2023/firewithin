  ...
  const saveCurrentTime = async (time) => {
    try {
       const body = new URLSearchParams();
        ...
        const res = await api.post(`${API_URL}updateAutoTimeSet/${lesson_id}`, body, {
        headers: { "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8" },
        withCredentials: true,
      });
      console.log(res);
...
"
          ...
          <div className="bg-[#FF2C00] p-10 flex text-lg justify-center items-center gap-6">
            ...
            <button id="rewindBtn" className="hover:cursor-pointer group transition-all duration-300" onClick={() => handleSkip(-15)}>
              <svg className="w-6 h-6 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 transition-transform duration-300 ease-in-out group-hover:scale-110" viewBox="0 0 48 53" fill="none" xmlns="http://www.w3.org/2000/svg">
...
>
  {isPlaying ? (
    ...
    <CiPlay1 className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12" />
            ...
            <button id="forwardBtn" className="hover:cursor-pointer group transition-all duration-300" onClick={() => handleSkip(15)}>
              <svg className="w-6 h-6 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 transition-transform duration-300 ease-in-out group-hover:scale-110" viewBox="0 0 47 53" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button id="next-page" className="changePage hover:cursor-pointer group transition-all duration-300"  data-type="section" data-section="6" data-course="1" data-lessonindex="0" onClick={() => handleNext()}>
              <svg className="w-6 h-6 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 transition-transform duration-300 ease-in-out group-hover:scale-110" viewBox="0 0 33 37" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className="indexact hover:cursor-pointer group transition-all duration-300" onClick={() => setIsSliderOpen(!isSliderOpen)}>
              <svg className="w-6 h-6 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 transition-transform duration-300 ease-in-out group-hover:scale-110" viewBox="0 0 42 34" fill="none" xmlns="http://www.w3.org/2000/svg">
