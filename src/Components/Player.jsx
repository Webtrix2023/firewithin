...
"
          ...
          >
            <button
              id="prev-page"
              className="changePage hover:cursor-pointer group transition-all duration-300"
              data-type="section"
              data-section="4"
              data-course="1"
              data-lessonindex="0"
            ...
            <button
              id="rewindBtn"
              className="hover:cursor-pointer group transition-all duration-300"
            ...
            <button
              className="indexact hover:cursor-pointer group transition-all duration-300"
