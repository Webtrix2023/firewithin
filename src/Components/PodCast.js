...
export const PodCast = () => {
    ...
    const loadPage = async ({ sectionId = currentSection, index = lessonIndex, type = "current", saveProgress = false } = {}) => {
        try {
            ...
            await updateAutoPage(lessonIndex);
    ...
    return (
        <div className="h-screen flex flex-col overflow-hidden">
            ...
            <div className="flex-1 flex items-center justify-center bg-[#F9FAFB] relative ">
                {/* Player Card */}
                <div
                    className="h-[70vh] w-[95%] sm:w-4/5 md:w-2/3 lg:w-1/2 rounded-3xl flex flex-col justify-between bg-[#8DE0FB] shadow-xl"
                >
                    {/* Top Section */}
                    ...
                    <div className="w-full shadow-lg flex flex-col rounded-b-3xl">
                        ...
                        <input
                            ...
                            onChange={handleSeek}
                            className="w-[90%] h-2 rounded-lg appearance-none cursor-pointer self-center"
                            style={{
