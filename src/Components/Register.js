...
// //                   <FiUser className={`text-xl ${focused.name ? 'text-gray-500' : 'text-gray-400'}`} />
// //                   <input
// //                     type="text"
// //                     name="name"
...
// //                 </label>
// //                 <div className="flex items-center gap-2">
// //                   <FiMail className={`text-xl ${focused.email ? 'text-gray-600' : 'text-gray-400'}`} />
// //                   <input
// //                     type="email"
// //                     name="email"
...
// //                     <FiUser className={`text-2xl ${focused.name ? 'text-gray-600' : 'text-gray-400'}`} />
// //                     <input
// //                       type="text"
// //                       name="name"
// //                       placeholder={t("enter_name")}
...
// //                   </label>
// //                   <div className="flex items-center space-x-3">
// //                     <FiMail className={`text-2xl ${focused.email ? 'text-gray-600' : 'text-gray-400'}`} />
// //                     <input
// //                       type="email"
// //                       name="email"
// //                       placeholder={t("enter_email")}
